...
namespace Words
{
    public class Stemmer
    {
        ...
        const string CPerfectiveground = "((ив|ивши|ившись|ыв|ывши|ывшись)|((?<=[ая])(в|вши|вшись)))$";
        ...
        const string c_noun =
            "(а|ев|ов|ие|ье|е|иями|ями|ами|еи|ии|и|ией|ей|ой|ий|й|и|иям|ям|ием|ем|ам|ом|о|у|ах|иях|ях|ы|ь|ию|ью|ю|ия|ья|я)$";
        ...
        public string Stem(string Word)
        {
            ...
            do
            {
                ...
                if (!RegexReplace(ref rv, CPerfectiveground, string.Empty))
                {
                    ...
                    else if (!RegexReplace(ref rv, c_verb, string.Empty))
